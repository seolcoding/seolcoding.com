    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pt-4">
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-neutral-900">Anthropic 공식 프롬프트 엔지니어링 코스</h2>
          <p className="text-neutral-600">Anthropic 공식코스의 주피터 노트북을 번역하고 웹앱으로 리팩터링했습니다</p>
        </div>
