...
Note that 📖 Theme & Addons📖 Theme & Addons can provide additional components. To add your own components, see 📖 Components📖 Components.
...
cards ('hidden' | 'visible', default 'visible'): tweet embed parameter
